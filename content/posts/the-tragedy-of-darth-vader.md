...
{{< figure src="/vader-doing-wounds.png" caption="Vader is landing usually between 2 and 3 guaranteed wounds" >}}
...
- `Pierce 3` is often overkill; it's not rare as Darth Vader to _intentionally_
...
{{< figure src="/vader/3-pip-master-of-evil.png" caption="Master of Evil: Another excellent command card. More like this!" >}}

Master of Evil does three _excellent_ things (at least compared to other cards):
...
[sabine wren]: https://starwarslegion.fandom.com/wiki/Sabine_Wren
...
> courage-2 core units, easy access to _Strict Orders_, and more.

### Darkness Descends

{{< figure src="/vader/3-pip-darkness-descends.png" caption="Darkness Descends: Another bait and switch (good but actually not)" >}}
...
3. This card has a strange anti-synergy _with_ Darth Vader; in the commander
...
4. The ability granted is much more situational and board dependent than you'd
   ...
   the power level of most other commanders which are _natively_ fast enough not
   to care as much as Vader does.
5. Finally, Vader lists _already_ had a difficult time building up a decent
   activation count (9 is common, 10 is possible) and impactful command cards
   and this card _guarantees_ your opponent can lose priority with
...
[diplomatic cover]: https://starwarslegion.fandom.com/wiki/Diplomatic_Cover
[i make the rules now]: https://starwarslegion.fandom.com/wiki/I_Make_the_Rules_Now
[coordinated fire]: https://starwarslegion.fandom.com/wiki/Coordinated_Fire
[assault]: https://starwarslegion.fandom.com/wiki/Assault
...
_independent_ activations in less than 600 points - something extremely tough
...
{{< figure src="/vader/list-with-irg.jpg" caption="Pairs up Darth Vader with Imperial Royal Guards" >}}
...
[imperial special forces]: https://starwarslegion.fandom.com/wiki/Imperial_Special_Forces

### Vader and Veers

{{< figure src="/vader/list-with-veers.jpg" caption="Pairs up Darth Vader with General Veers" >}}
...
relying on _electrobinoculars_ for gunline effectiveness with Darth Vader have
...
[imperial discipline]: https://starwarslegion.fandom.com/wiki/Imperial_Discipline
...
It's _hard_ to built a list around him, in a way that it probably would _not_ be
...
{{< figure src="/vader/luke-skywalker.png" caption="Luke Skywalker: Darth Vader's son packs a punch and then some" >}}

Luke is the _gold_ standard for a core-box commander: he is independent, has
...
and that is _only_ his core (non-Operative) cards - his operative cards _kick_
...
- Command cards that are less situational, including those that make Luke nearly
  ...
  _take control_ of an enemy unit.
...
more difficult to navigate with _any_ Jedi right now thanks to a proliferation
of standby-Clones and heavy-hitting range-4 armor, continues to be excellent and
_feels_ like Luke Skywalker.

### General Grievous

{{< figure src="/vader/general-grievous.png" caption="General Grievous: A Cyborg that decided to retain the ability to run" >}}
...
super synnergyistic _two_ command slots.
...
Grievous has a lot of internal competition, like [Count Dooku](#dooku), but is
a strong pick that, aside from a low courage, is fairly straightforward to play.

[trained in your jedi arts]: https://starwarslegion.fandom.com/wiki/Trained_in_Your_Jedi_Arts

### Obi-Wan Kenobi

{{< figure src="/vader/obi-wan.png" caption="Obi-Wan Kenobi: Somehow still a better Luke Skywalker. Who knew?" >}}

Obi-Wan is likely the most well-rounded Jedi, with strong defensive and
offensive capabilities that are almost guaranteed to get _better_ over time with
future access to medics. Go ahead and re-read [Luke Skywalker](#luke), and then
apply the following.

In comparison to Vader:

- Obi-Wan has three _excellent_ command cards offering extreme amount of army
  ...
  himself and throw his taken _back_ in the order pool to get this effect?
- The Clone faction has plenty of access to strong, independent units that don't
  ...
  probably _any_ GAR commander, can rely more on the army list than Vader can.
...
[knowledge and defense]: https://starwarslegion.fandom.com/wiki/Knowledge_and_Defense
[general kenobi]: https://starwarslegion.fandom.com/wiki/General_Kenobi
[hello there]: https://starwarslegion.fandom.com/wiki/Hello_There
[clone captain rex]: https://starwarslegion.fandom.com/wiki/Clone_Captain_Rex

### Emperor Palpatine {#palpatine}

{{< figure src="/vader/emperor-palpatine.png" caption="Emperor Palpatine: I guess there is a reason he's the master?" >}}
...
as Palpatine is _also_ the other `Speed: 1` commander.
...
[give in to your anger]: https://starwarslegion.fandom.com/wiki/Give_in_to_Your_Anger
[and now... you will die]: https://starwarslegion.fandom.com/wiki/And_Now..._You_Will_Die
[an entire legion]: https://starwarslegion.fandom.com/wiki/An_Entire_Legion

Palpatine has won several major events despite being a trickier play than say
[Luke Skywalker](#luke), but is definitely getting tougher to play with the
increase in high-volume long-range attacks. However, he's still looking better
than Vader!

### Count Dooku {#dooku}

{{< figure src="/vader/count-dooku.jpg" caption="Count Dooku: Or, what if Vader was actually scary to other Jedi?" >}}
...
- A _command_ slot, just like with Grevious, can basically read
...
[anakin skywalker]: https://www.fantasyflightgames.com/en/products/star-wars-legion/products/anakin-skywalker-commander-expansion/
[darth maul]: https://www.fantasyflightgames.com/en/products/star-wars-legion/products/darth-maul-and-sith-probe-droids-operative-expansion/

## You need to play 6 turns {#turn-6}

Even after all of these comparisons, it is _still_ possible to play a halfway
decent Darth Vader, and to win in competitive events (though I'd argue the
ability to do so _reliably_, if that matters for you, is fairly low). However,
...
{{< figure src="/vader/operative-vader.jpg" caption="Operative Vader: You can now further harm yourself to play like other units" >}}
